      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 dark:bg-gray-800 bg-gray-100">
        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="text-center pb-12 md:pb-16">
            <h1
              className="text-5xl md:text-6xl font-extrabold leading-tighter tracking-tighter mb-4 dark:text-gray-300 text-gray-900"
              data-aos="zoom-y-out"
            >
              IE Tecnologia
            ...
            <div className="max-w-3xl mx-auto">
              <p
                ...
                data-aos-delay="150"
              >
                A mais de 13 anos desenvolvendo produtos e sistemas de
                gerenciamento de energia e de Automação Industrial.
              </p>
              <div
              ...
              >
                ...
                <div>
                  <a
                    className="btn text-white bg-gray-900 hover:bg-gray-800 dark:hover:bg-gray-700 w-full sm:w-auto sm:ml-4"
                    href="https://github.com/Anderson-Andre-P"
                    target="_blank"
                  >
                    Saiba mais
